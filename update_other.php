    ...
    <div class="main">
        ...
        <div class="container">
            <form method="POST" class="appointment-form" id="appointment-form">
				...
				<input type="others" name="others" id="others" placeholder="Enter your group" required="_required" />
                ...
                <div class="form-submit">
                    <input type="submit" name="update" id="update" class="update" value="update Contact" />
...
mysqli_query($con,$sql);
     if(mysqli_connect_errno())
	 {
		...
		echo "failed ".mysqli_connect_error;
			...
			mysqli_query($con,"update contacts set phone_number_one='$phone_number_two' where phone_number_one='$phone_number_one'");
